...
angular.module('dashboardApp')
  .controller('DashboardCtrl', function ($scope, $state, ProspectService, UsersService) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
console.log("in createCharts");
            ...
            $scope.chartData = {
                ...
                "series3": [$scope.SalesPersons[0], $scope.SalesPersons[1], $scope.SalesPersons[2]],
                "data": [],
                "data1": [],
                "data2": [],
                "data3": [],
                    ...
                    $scope.months.forEach(function (i, m) {
                        ...
                        if ((typeof project.start_date) == "string") {
                            ...
                            if (date3.getMonth() == m) {
                                ...
                                } else if (project.initiatedBy == $scope.SalesPersons[1]) {
                                    $scope.initiatedBy3[m] = $scope.initiatedBy3[m] + 1;
                                } else if (project.initiatedBy == $scope.SalesPersons[2]) {
