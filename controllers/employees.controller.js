...
exports.employeeStartsWith=function(req,res,next,name){
...
exports.employeeStartsWith1=function(req,res,next,name){
    ...
    Employees.find({name:new RegExp(name, 'i')},function(err,employee){
   // Employees.find({ name: { $regex: /^man/ }},function(err,employee){
        if(err){
            next(err);
        }
        if(employee){
